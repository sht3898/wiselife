...
```sql
alter table meeting add fulltext key(title);
alter table meeting add fulltext key(content);
alter table meeting add fulltext key(area1);
alter table meeting add fulltext key(area2);
alter table meeting add fulltext key(tags);
```
